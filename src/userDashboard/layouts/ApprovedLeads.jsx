      ...
      <div className="px-4 sm:px-6 lg:px-8 pb-8 max-w-7xl mx-auto">
        ...
        >
                ...
                {loading ? (
                  ...
                  filteredLeads.map((lead) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">₹{lead.commission1 || 0}</td>
                    </tr>
                  ))
                ) : (
                  <tr>
          ...
          <div className="sm:hidden flex flex-col gap-4 p-4">
            {loading ? (
              <div className="text-center py-8 text-gray-500">Loading approved leads...</div>
            ) : filteredLeads.length > 0 ? (
              filteredLeads.map((lead) => (
                <div
                  key={lead._id}
                ...
                >
                  ...
                  <p className="text-sm">
                    <strong>Approved:</strong> {formatDate(lead.updatedAt)}
                  </p>
                </div>
              ))
            ) : (
