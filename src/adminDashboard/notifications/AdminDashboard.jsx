      ...
      <main className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <button onClick={() => navigate("/admin/notifications/incomplete-profile")}>
            <div className="group cursor-pointer rounded-lg border border-border bg-card p-8 transition-all hover:border-[#4406CB] hover:shadow-lg text-left">
              <div className="mb-4 inline-flex rounded-lg bg-[#4406CB]/10 p-3">
                <Users className="h-6 w-6 text-[#4406CB]" />
              </div>
              ...
              <div className="mt-6 flex items-center gap-2 text-[#4406CB] font-medium group-hover:gap-3 transition-all">
        ...
        <div className="mt-8">
          ...
          >
            <div className="group cursor-pointer rounded-lg border border-border bg-card p-6 transition-all hover:border-[#4406CB] hover:shadow-lg text-left">
              <div className="flex items-center gap-4">
                <div className="inline-flex rounded-lg bg-[#4406CB]/10 p-3">
                ...
                <div className="flex items-center gap-2 text-[#4406CB] font-medium group-hover:gap-3 transition-all">
